...
| -------------------------- | -------------------------- | ----------- | ------------------------------------------------------------------------------------ |
| admin@dts.unc.edu.ar       | Disponible en credenciales | admin       | Full admin dashboard, user CRUD, track/course CRUD, Moodle sync, integration logs    |
| nahuelgomez.cti@gmail.com  | Disponible en credenciales | estudiante  | Student dashboard, progress view, eligibility check, exam registration, certificates |
| coordinador@dts.unc.edu.ar | Disponible en credenciales | coordinador | Track management, enrollment, override creation, grade recording                     |
| estudiante@dts.unc.edu.ar  | Disponible en credenciales | estudiante  | Student dashboard, progress view, eligibility check, exam registration, certificates |
...
| Schema      | public (Multiple tables for domain entities)                  |
